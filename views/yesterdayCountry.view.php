...
$curl = curl_init('https://corona.lmao.ninja/v2/countries/ma,dz,uae,eg,tn,ps,jo,om,sdn,mr,dj,so,com,bh,sa,iraq,lebanon,libya,yemen,syria,iran,qatar,kuwait?yesterday=true');
  ...
  <div class="col-lg">
    <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a href="countries.php" class="btn btn-light">Today</a>
              <a href="countries.php?yesterday=True" class="btn btn-primary">Yesterday</a>
            </div>
            <div class="card-body">
            ...
            if($data === false){
                ...
                if(curl_getinfo($curl, CURLINFO_HTTP_CODE) === 200){
                    ...
                    //echo '<pre>';
                    //var_dump($data);
                    //var_dump($data[0]['countryInfo']['iso2']);
                    //echo '</pre>';
                    $count = count($data);
